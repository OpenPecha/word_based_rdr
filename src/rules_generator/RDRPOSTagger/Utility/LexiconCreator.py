...
def createLexicon(corpusFilePath, fullLexicon):
    ...
    # else:
    #    print "Creating a short .sDict lexicon which excludes word types appearing 1 time in the
    #  gold standard training corpus"

    lines = open(corpusFilePath, encoding="utf-8").readlines()
    wordTagCounter: Dict[str, Dict[str, int]] = {}  # wordTagCounter = {}
